...
```bash
git clone https://github.com/MichelGL/python-course-countries-informer.git
```
...
3. Now it is possible to run the project inside the Docker container:
    ...
    docker compose up
    ```
   When containers are up server starts at [http://127.0.0.1:8020](http://127.0.0.1:8020). You can open it in your browser.
...
1. To manage your new portfolio website you need to add superuser.
   ...
   Create superuser:
    ...
    ```
2. Go to [http://127.0.0.1:8020/admin](http://127.0.0.1:8020/admin) and manage your jobs and blog posts.

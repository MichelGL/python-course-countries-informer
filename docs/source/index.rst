...
4. После сборки контейнеров можно их запустить командой:
    ...
    Когда запуск завершится, сервер начнет работать по адресу `http://127.0.0.1:8020`.
...
2. После создания администратора можно зайти в панель управления сайтом по адресу http://127.0.0.1:8020/admin.
